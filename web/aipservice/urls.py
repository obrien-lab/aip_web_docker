...
urlpatterns = [
  ...
  path('offset_report/<str:task_id>/', views.OffsetReportView.as_view(), name='offset_report'),
  path('profile_report/<str:task_id>/', views.ProfileReportView.as_view(), name='profile_report'),
